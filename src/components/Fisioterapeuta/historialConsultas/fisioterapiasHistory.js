...
const FisioterapiasHistory = () => {
    ...
    const [updateConsultas, setUpdateConsultas] = useState(true);
    ...
    const getConsultas = () => {
        axios
            .get(
                `${BASE_URL}/fisioterapeuta/obtenerevaluaciones/${id}?page=${pagination.activePage}&token=${token}`
            )
            .then(response => {
...
export default FisioterapiasHistory;
