...
import ConsultaDatosDeportivos from '../consutaDatosPersonales/consultarDatosDeportivos';
import TiposDeportistasDefinicion from './TiposDeportistas/TiposDeportistasDefinicion';
import ModalViewDefinition from './TiposDeportistas/modalViewDefinition';
...
const SportForm = () => {
    ...
    return (
        <div className='container-form-sgdar'>
            ...
            <h1 className='title-form'>Ingresa tus datos deportivos</h1>
