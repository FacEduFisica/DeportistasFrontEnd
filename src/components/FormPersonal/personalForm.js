...
import ConsultaDatosPersonales from '../consutaDatosPersonales/consultaDatosPersonales';
import TerminosCondiciones from '../condicionesLegales/terminosCondiciones';
...
const PersonalForm = () => {
    ...
    useEffect(() => {
        ...
        axios
            .get(`${BASE_URL}/user/datospersonales/${id}?token=${token}`)
            .then(response => {
                const {
    ...
    return (
        <div className='container-form-sgdar'>
            {swTerminosCondiciones && <TerminosCondiciones setTerminosCondiciones={setTerminosCondiciones} />}
            <h1 className='title-form'>Ingresa tus datos personales</h1>
            {swForm ? (
                    ...
                    <div className='container-row-form'>
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Seleccione su de tipo de documento.' icon="help circle"/>
                            </div>
                            <Dropdown
                        ...
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Ingrese el número de documento.' icon="help circle"/>
                            </div>
                            <input
                        ...
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Ingrese lugar de expedición de su documento.' icon="help circle"/>
                            </div>
                            <input
                                className='input-form'
                                type='text'
                    ...
                    <div className='container-row-form'>
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Seleccione el tipo de sexo al cual pertenece' icon="help circle"/>
                            </div>
                            <Dropdown
                                className='input-dropdown'
                                placeholder='Sexo'
                        ...
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Ingrese su fecha de nacimiento.' icon="help circle"/>
                            </div>
                            <input
                                className='input-form'
                                required
                        ...
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Ingrese su(s) nombre(s).' icon="help circle"/>
                            </div>
                            <input
                                className='input-form'
                                type='text'
                    ...
                    <div className='container-row-form'>
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Ingrese su primer apellido.' icon="help circle"/>
                            </div>
                            <input
                                className='input-form'
                                type='text'
                        ...
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Ingrese su segundo apellido.' icon="help circle"/>
                            </div>
                            <input
                                className='input-form'
                                type='text'
                        ...
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Ingrese su edad.' icon="help circle"/>
                            </div>
                            <input
                                className='input-form'
                                type='number'
                    ...
                    <div className='container-row-form'>
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Ingrese pais en el cual nació.' icon="help circle"/>
                            </div>
                            <input
                                className='input-form'
                                type='text'
                        ...
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Seleccione su estado civil.' icon="help circle"/>
                            </div>
                            <Dropdown
                                className='input-dropdown'
                                required
                    ...
                    <div className='container-row-form'>
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Seleccione su seguridad social.' icon="help circle"/>
                            </div>
                            <Dropdown
                                className='input-dropdown'
                                required
                        ...
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Seleccione el grupo sanguineo al cual pertenece.' icon="help circle"/>
                            </div>
                            <Dropdown
                                className='input-dropdown'
                                required
                        ...
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Ingrese su peso.' icon="help circle"/>
                            </div>
                            <input
                                className='input-form'
                                type='number'
                    ...
                    <div className='container-row-form'>
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Ingrese su talla.' icon="help circle"/>
                            </div>
                            <input
                                className='input-form'
                                type='number'
                        ...
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Seleccion si tiene alguna discapacidad.' icon="help circle"/>
                            </div>
                            <Dropdown
                                className='input-dropdown'
                                required
                        ...
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Seleccione el tipo en que se encuentra clasificada su discapacidad.' icon="help circle"/>
                            </div>
                            <Dropdown
                                className='input-dropdown'
                                required
                    ...
                    <div className='container-row-form'>
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Seleccione la etnia a la cual pertenece.' icon="help circle"/>
                            </div>
                            <Dropdown
                                className='input-dropdown'
                                required
                        ...
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Seleccione si es desplazado o no.' icon="help circle"/>
                            </div>
                            <Dropdown
                                className='input-dropdown'
                                required
                        ...
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Seleccione si se trabaja o no.' icon="help circle"/>
                            </div>
                            <Dropdown
                                className='input-dropdown'
                                required
                    ...
                    <div className='container-row-form'>
                        <div className='container-input'>
                            <div className='container-label'>
                                ...
                                <Tooltip text='Seleccione si es cabeza de hogar o no.' icon="help circle"/>
                            </div>
                            <Dropdown
                                className='input-dropdown'
                                required
